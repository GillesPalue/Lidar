...
*																		  *
*	Mises à jour :														  *
*	- automne 2024 : test des fichiers inutiles avant suppression		  *
***************************************************************************
"""
...
class ExampleProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        ...
        """
        return self.tr('1. Nuages de points (.laz) -> rasters (.tif)')
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterString(
                self.CLASSIFICATION,
                self.tr('\nClasses séparées par des virgules (sol = 2)'),
                '2'))
            ...
            if f[-4:] in (".las" ,".laz"): 
                ...
                try :
                    processing.run("pdal:exportrastertin", {
                        # Gilles avant : processing.run("pdal:exportraster", {
                        'INPUT': full_path,
                        # Gilles avant : 'ATTRIBUTE' : 'Z',
                    ...
                    # Gilles : étape 2 : compression du fichier raster .tif
                    ...
                    # Gilles : étape 3 : suppression des fichiers bruts
